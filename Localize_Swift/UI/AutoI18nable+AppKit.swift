...
import Foundation
...
#if os(macOS)
    import AppKit
    @MainActor extension NSTableColumn: AutoI18nable {
    ...
    @MainActor extension NSSegmentedControl: AutoI18nable {
    ...
    @MainActor extension NSTextField: AutoI18nable {
        public func setString(value: String, forTag tag: String? = nil) {
            switch tag?.lowercased() {
            case "placeholder":
    ...
    @MainActor extension NSButton: AutoI18nable {
    ...
    @MainActor extension NSTextView: AutoI18nable {
        public func setString(value: String, forTag tag: String? = nil) {
            switch tag {
            default:
                string = value
    ...
    @MainActor extension NSMenuItem: AutoI18nable {
        public func setString(value: String, forTag tag: String? = nil) {
            switch tag?.lowercased() {
            case "tooltip":
                toolTip = value
    ...
    @MainActor extension NSTabViewItem: AutoI18nable {
        public func setString(value: String, forTag tag: String? = nil) {
            switch tag?.lowercased() {
            case "tooltip":
                toolTip = value
