...
@MainActor public protocol AutoI18nable: AnyObject {
...
private struct AssociatedKeys {
    nonisolated(unsafe) static var localizedKey: UnsafeRawPointer = UnsafeRawPointer(
        bitPattern: "localizedKey".hashValue)!
    nonisolated(unsafe) static var weakTableHolder: UnsafeRawPointer = UnsafeRawPointer(
        bitPattern: "weakTableHolder".hashValue)!
}

class WeakTableHolder: NSObject, @unchecked Sendable {
