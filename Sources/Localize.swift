...
extension String {
    ...
    /**
     ...
     - Returns: The localized string.
    */
    public func commented(_ argument: String) -> String {
        return self
    }
}
...
open class Localize: NSObject {
    ...
    open class func currentLanguage() -> String {
        if let currentLanguage = UserDefaults.standard.object(forKey: LCLCurrentLanguageKey)
            as? String
        {
    ...
    open class func setCurrentLanguage(_ language: String) {
        let selectedLanguage =
            availableLanguages().contains(language) ? language : defaultLanguage()
